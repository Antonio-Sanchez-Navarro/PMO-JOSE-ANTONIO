...
- [x] 🟢 Panel de auditoría: ver por qué se asignó una prioridad — _no existe en el frontend_
...
- [x] 🟡 Bandeja: botón para devolver un correo a pendientes (Gravity) — ✅ _Botón implementado_
...
- [x] 🟢 Gráfica de tiempos (Recharts) en el dashboard — ✅ _Implementado con Recharts en `TimeReportModal.tsx`_
